...
$sql1 = "SELECT * FROM er_analytics WHERE ip='".$user_ip."'";
...
{
$sql2 = "INSERT INTO er_analytics(ip) VALUES('".$user_ip."')";
$conn->query($sql2);
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <meta name="description" content="er-Chaan">
    <meta name="author" content="er-Chaan">
    <title>er-Chaan</title>
    ...
    <script type="application/ld+json">
        {
          ...
          "@type": "Person",
          "name": "er-Chaan",
          "disambiguatingDescription": "The Autonomous Culture",
          "email": "mailto:er.chandreshbhai@gmail.com",
          "image": "http://er-Chaan.xyz/official/ima/er-Chaan.png",
          "jobTitle": "Project Engineer",
          "telephone": "+91-9004313006",
          "url": "http://er-chaan.xyz",
            "address": [{
            "@type": "PostalAddress",
  ...
  <body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">er-Chaan</span>
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/er-Chaan.png" alt="er-Chaan">
        </span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="er-Chaan.pdf" target="_blank">Download</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container-fluid p-0">
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">er-
            <span class="text-primary">Chaan</span>
          </h1>
          <div class="subheading mb-5">Po-Box#390025, India · +91.900.4313.006 ·
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div class="subheading mb-3">EDU Books Solutions Pvt Ltd, India</div>
            </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div class="subheading mb-3">Russmedia Tech Pvt Ltd, India</div>
            </div>
            <div class="resume-date text-md-right">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div class="subheading mb-3">Golden Fox Business Solutions Pvt Ltd, India</div>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">June 2015 - June 2016</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div class="subheading mb-3">Bachelor of Engineering in Computer Technology</div>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">June 2012 - June 2015</span>
            </div>
          </div>
          <div class="resume-item d-flex flex-column flex-md-row">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">University of Mumbai</h3>
              <div class="subheading mb-3">Diploma Engineering in Computer Technology</div>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">June 2009 - June 2012</span>
            </div>
          </div>
        </div>
      </section>
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
          ...
          <ul class="list-inline list-icons">
            ...
            <li class="list-inline-item">
              <i class="devicons devicons-jquery_ui"></i>
            </li>
            <li class="list-inline-item">
              <i class="devicons devicons-npm"></i>
            </li>
            <li class="list-inline-item">
              <i class="devicons devicons-google_drive"></i>
            </li>
            <li class="list-inline-item">
            ...
            <li class="list-inline-item">
              <i class="devicons devicons-google_analytics"></i>
            </li>
            <li class="list-inline-item">
              <i class="devicons devicons-atom"></i>
            </li>
            <li class="list-inline-item">
              <i class="devicons devicons-opensource"></i>
            </li>
            <li class="list-inline-item">
            ...
            <li class="list-inline-item">
              <i class="devicons devicons-code_badge"></i>
            </li>
            <li class="list-inline-item">
              <i>..... ..</i>
            </li>
         ...
         er-Chaan &copy; Copyright <?php echo date('Y');?> Powered by <a href="http://www.er-Chaan.xyz" title="er-Chaan">er-Chaan</a>
         <br>
         <?php
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/593d25aab3d02e11ecc69464/default';
            s1.charset='UTF-8';
